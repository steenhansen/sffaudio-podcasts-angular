...
console.log('episodes/a-new-releases.js');
...
describe('Episodes List Pieces -', function testPodcastTypes() {
    ...
    describe('Audiobook should match -309-', function () {
        var view_podcast = {
            ...
            "a_or_an_kind":"",
            "about_display":""     };
        var the_podcast_url_match = "#\/new-releases-recent-arrivals\/" + view_podcast.padded_podcast_id;
        ...
        it('should have correct a or an prefix', function () {
            expect(element(by.binding('a_podcast.a_or_an_kind'))).toBeDefined(false);
        });
