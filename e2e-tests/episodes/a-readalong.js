...
console.log('episodes/a-readalong.js');
...
describe('Episodes List Pieces -', function testPodcastTypes() {
    ...
    describe('Audiobook should match -333-', function () {
        var view_podcast = {
            ...
            "a_or_an_kind":"A",
            "about_display":""          };
        var the_podcast_url_match = "#\/readalong\/" + view_podcast.padded_podcast_id;
