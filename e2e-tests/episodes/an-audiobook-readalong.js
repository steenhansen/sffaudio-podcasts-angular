...
console.log('episodes/an-audiobook-readalong.js');
...
describe('Episodes List Pieces -', function testPodcastTypes() {
    ...
    describe('Audiobook should match -334-', function () {
        var view_podcast = {
            ...
            "a_or_an_kind":"An",
            "about_display":""           };
        var the_podcast_url_match = "#\/audiobook-readalong\/" + view_podcast.padded_podcast_id;
