...
console.log('podcast/audiobook-readalong.js');
	describe('An Audiobook/Readalong Podcast -', function () {
		var test_podcast_id = 334;
		var the_type = 'audiobook-readalong';
		var type_text = 'An AUDIOBOOK-READALONG';
		var view_podcast = {
			...
			"download_name": "SFFaudioPodcast334.mp3",
			"word_press_post": "http:\/\/www.sffaudio.com\/?p=55392",
			"about_display": "",
			"twitter": "original_referer=http%3A%2F%2Fwww.sffaudio.com%2F&amp;text=SFFaudio%20Podcast%20The%20Birth-Mark%20by%20Nathaniel%20Hawthorne&amp;url=http%3A%2F%2Fwww.sffaudio.com%2F%3Fp%3D55392"
		};

		var test_podcast_page = 'mobile_podcasts.html#/' + the_type + '/' + test_podcast_id;
		var zero_seconds = '0s';

		var download_match = "^http:\/\/localhost:8000\/podcasts\/SFFaudioPodcast334\.mp3$";
		...
		it('AUDIOBOOK-READALONG : should show the download link', function () {
			describe("follow the download link", function() {
				...
				it("download link should be there, AUDIOBOOK-READALONG", function() {
		...
		it('AUDIOBOOK-READALONG : should show the wordpress post', function () {
			describe("follow the wordpress link", function() {
				...
				it("wordpress post should be there, AUDIOBOOK-READALONG", function() {
		...
		it('AUDIOBOOK-READALONG : should show the twitter link', function () {
			describe("follow the twitter link", function() {
				...
				it("twitter link should be there, AUDIOBOOK-READALONG", function() {
